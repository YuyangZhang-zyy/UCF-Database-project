...
function createEvent($conn, $eventname, $eventdesc, $eventphone, $eventdatetime, $eventlat, $eventlong, $eventtype, $uniid) 
{
...
function createRSOEvent($conn, $eventname, $eventdesc, $eventphone, $eventdatetime, $eventlat, $eventlong, $eventtype, $userid, $rsoid, $uniid)
{
	if (locationExists($conn, $eventlat, $eventlong) === FALSE)
		createLocation($conn, $eventlat, $eventlong);
...
function requestEvent($conn, $eventname, $eventdesc, $eventphone, $eventdatetime, $eventlat, $eventlong, $eventtype, $usersid) 
{
	$uniid = getUsersUniversity($conn, $usersid);

	createEvent($conn, $eventname, $eventdesc, $eventphone, $eventdatetime, $eventlat, $eventlong, $eventtype, $uniid);
...
function isEmptyRequestEvent($eventname, $eventdesc, $eventphone, $eventdate, $eventtime, $eventtime2, $eventlat, $eventlong, $eventtype) 
{
	if (empty($eventname) || empty($eventdesc) || empty($eventphone) || empty($eventdate) || empty($eventtime) || empty($eventtime2) || empty($eventlat) || empty($eventlong) || empty($eventtype))
		return true;
	else
		return false;
}

function isEmptyCreateEvent($rsoid, $eventname, $eventdesc, $eventphone, $eventdate, $eventtime, $eventtime2, $eventlat, $eventlong, $eventtype) 
{
	if (empty($rsoid) || empty($eventname) || empty($eventdesc) || empty($eventphone) || empty($eventdate) || empty($eventtime) || empty($eventtime2) || empty($eventlat) || empty($eventlong) || empty($eventtype))
		return true;
	else
		return false;
}