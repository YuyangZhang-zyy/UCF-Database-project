...
<?php
	...
	if (isSuperAdmin($conn, $usersId) !== FALSE)
		echo "<h3>Since you are the super admin, you can request an event and then accept that request in 'Pending Events'.</h3>";
?>
	...
	<div class="card-body">
		<?php
			if(isset($_GET["error"])) 
			{
				...
				if ($_GET["error"] == "none")
					echo "<p style='color:#500'>You successfully requested for an event! Please waiting for the super-admin approve it.<br><br></p>";
			}
		?>
