...
<h3> To be the super-admin for new university, complete the following new university sign up. </h3>
			...
			<div class="row row-space">
				<div class="col-2">
					<div class="input-group">
						<input class="input--style-1" type="text" name="lat" placeholder="Unviersity Location Latitude...">
					</div>
				</div>
				<div class="col-2">
					<div class="input-group">
						<input class="input--style-1" type="text" name="long" placeholder="Unviersity Location Longitude...">
					</div>
				</div>
			</div>
			<h4><b>UNIVERSITY INFOMATION</b></h4>
			<div class="input-group">
