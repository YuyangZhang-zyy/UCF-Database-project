			...
			if (isset($_SESSION["usersId"])) 
			{
				...
				while($row = mysqli_fetch_assoc($eventdata)) 
				{
					...
					if ($eventinfo["eventsRid"] !== NULL) 
					{
						...
						echo "<h2>" . $uniname . "</h2>";
					echo "<h4><b>" . $eventname . "<br>" . date('m-d-Y', $eventdatetime) . "<br>" . date('ha', $eventdatetime) ."</b></h4>";
					echo "<p>" . $eventdesc . "<br><br>Latitude: " . $eventlat . "<br>Longitude: " . $eventlong ."<br><br>Phone #: ". $eventphone . "<br><br>Visibility: " . strtoupper($eventtype) . "</p>";
					
					echo "<button type='button' onclick='gotoComments(" . $eventid . ")'>Comments</button>";
					echo "<button type='button' onclick='attemptLeaveEvent(" . $eventid . ")'>Withdraw</button>";
					echo "</li>";
				}
			}
			else
	...
	<div class="modal-content">
		<div class="new-comment">
			...
			<form method="POST" id="new_comment_form">
				...
				<div>
					<textarea id="comment_field" name="comment_field" rows="2" placeholder="Write Your Comments Here!"></textarea>
